...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nitoneum " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nitoneumtools.com", "dnsseed.nitoneumtools.com"},
    {"nitoneumpool.org", "dnsseed.nitoneumpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nitoneumtools.com", "testnet-seed.nitoneumtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nitoneum is probably already running."), addrBind.ToString().c_str());
        else
